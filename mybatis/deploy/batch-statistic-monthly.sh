...
SERVICE_SRC_FOLDER=${PROJECT_FOLDER}/batch/batch-statistic-monthly/target
ARTIFACT=batch-statistic-monthly-0.0.1-SNAPSHOT.jar
SERVICE_NAME=batch-statistic-monthly
