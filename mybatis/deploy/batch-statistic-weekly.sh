...
SERVICE_SRC_FOLDER=${PROJECT_FOLDER}/batch/batch-statistic-weekly/target
ARTIFACT=batch-statistic-weekly-0.0.1-SNAPSHOT.jar
SERVICE_NAME=batch-statistic-weekly
