...
SERVICE_SRC_FOLDER=${PROJECT_FOLDER}/batch/batch-statistic-daily/target
ARTIFACT=batch-statistic-daily-0.0.1-SNAPSHOT.jar
SERVICE_NAME=batch-statistic-daily
